...
\texttt{results/test\_time\_measurements/20260225\_111731/summary.md}. La configuration utilisée
...
R0 & 0.948657 & 0.011420 & n/a \\
E0 & 0.001842 & 0.000113 & n/a \\
\bottomrule
\end{tabular}
\end{table}
...
Moyenne & 4.930332 & 3.979834 & 0.948657 & 1256341.072227 \\
Écart-type & 0.020446 & 0.009470 & 0.011420 & 2989.114282 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{enumerate}[leftmargin=*]
    ...
    d'initialisation (\(41.581492\) ms), alors que \(P1\)
    (\(0.891350\) ms) et \(P2\) (\(0.076836\) ms) restent faibles. Cette hiérarchie est cohérente
    ...
    D'après le tableau~\ref{tab:results-decomp}, \(K1\) représente \(93.4676\%\) du temps noyau,
    ...
    Toujours dans le tableau~\ref{tab:results-decomp}, \(K2\) pèse \(70.6659\%\) du noyau contre
    \(14.5942\%\) pour \(K3\).
    ...
    du nombre
    de threads. En particulier, \(S(16)=15.716398\) correspond à un facteur multiplicatif
